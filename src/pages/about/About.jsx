    ...
    <div className="about">
      ...
      <ContentWrapper>
        ...
        <div className="infoText">
          <b>Movizz: </b> Your Movie and TV Show Hub.
          <br /> Movizz is your ultimate destination for movie and TV show
          lovers.
          <br /> This web app, built with React 18, SCSS, and HTML, offers a
          seamless experience for exploring and watching your favorite content.
          <br />
          <b>Key Features:</b>
          <b>React 18: </b> Experience smooth navigation and responsiveness with
          React 18's concurrent rendering. <br /> <b>TMDB API:</b> Access the
          latest movie and TV show data from The Movie Database (TMDb) for
          up-to-date information. <br /> This integration ensures you have
          access to up-to-date information, including movie details, ratings,
          cast, crew, and more. Stay informed about the hottest releases and
          timeless classics. # <b>Responsive Design:</b>
          Access Movizz on any device, ensuring a consistent experience. <br />
          Explore, watch, and share your love for movies and TV shows with
          Movizz today.
          <div className="tmdbIcon">
            <svg
            ...
            <div className="infoTex">
              Developed by{" "}
              <a
                href="https://github.com/gauravxroy"
                style={{ color: "white", textDecoration: "none" }}
              >
                Gaurav Roy
              </a>
              <p>
                References : jsDev(yt), gfg, React Docs, Scss Docs, javaScript
                Docs, Tmdb Docs
              </p>
            </div>
          </div>
        ...
        <div className="socialIcons">
          <a href="https://github.com/gauravxroy">
            <span className="icon">
              <FaGithub />
            </span>
          </a>
          <a href="https://linkedin.com/in/gaurav-roy-155401218/">
            <span className="icon">
              <FaLinkedin />
            </span>
          </a>
